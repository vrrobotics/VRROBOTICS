 ...
 * TODO: implement business logic ported from TeamTrainingController, TeamPackagePurchase, TeamPackageMember.
 */
...
async function findById(id) {
  // TODO: findByPk + 404
  throw new AppError(`teamTraining #${id} not found`, 404);
}

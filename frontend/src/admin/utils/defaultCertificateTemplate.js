...
export const DEFAULT_BUILDER_CONTENT = `<div class="certificate-layout-module" style="position:relative;width:900px;height:600px;background:#fff;font-family:'Roboto',sans-serif;">
    ...
    <div class="draggable" style="position:absolute;left:90px;top:470px;font-size:16px;font-family:'Italianno', cursive;color:#FF6A00;text-align:center;font-style:italic">{instructor_name}</div>
